...
import { ChevronLeft, ChevronRight, Trophy, Flame, Zap, Settings } from 'lucide-react'
...
function prepProgress(examDate) {
  const now = new Date()
...
// ── Mini calendar ──────────────────────────────────────────────────────────
function Calendar({ activePlan, examDate: examDateProp }) {
  ...
  const examStr = examDateProp ?? '2026-07-29'
        ...
        <div className="flex flex-col md:flex-row md:gap-8 md:items-start">
          ...
          <div className="md:w-2/5 space-y-6">
            ...
            <div className="relative flex flex-col items-center text-center gap-2 pt-2">
              <button
                ...
                className="absolute right-0 top-0 p-2 rounded-lg text-slate-400 hover:text-white transition-colors"
              >
                <Settings className="w-5 h-5" />
              </button>
              <div className="w-20 h-20 rounded-full bg-teal-600 flex items-center justify-center text-2xl font-bold text-white flex-shrink-0 overflow-hidden">
                {profile?.avatar_url
              ...
              <div className="bg-slate-800 rounded-xl border border-slate-700 p-5">
                <div className="flex items-start justify-between mb-1">
                  <div>
                    ...
                    <p className="text-base font-semibold text-white mt-0.5">{EXAM_DATE.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                  </div>
          ...
          <div className="md:w-3/5 space-y-6 mt-6 md:mt-0">
            ...
            <div>
              ...
              <Calendar activePlan={activePlan} examDate={examDate} />
            </div>
